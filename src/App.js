  ...
  render() {
    ...
    return(
      ...
      <AppBar position="static"  style={style.appBar} className={toggle ? "toggle" : ""}>
          <Toolbar>
           <img src ={logo_1} height='80' width='80'/> 
              ...
              <Button href="/Contact Us" color="black" ><strong>ContactUs</strong></Button>
            ...
            <span><Typography style={{color:"black"}}>{cart.length}</Typography></span>
              ...
              {localStorage.getItem("userid") ?(
                <>
                <Button href="/profile" color="black"><strong><AccountCircleIcon style={{"fontSize":30}}>Account</AccountCircleIcon></strong></Button>
                <Button onClick={this.handlelogout} color="black"><strong>logout</strong></Button>
